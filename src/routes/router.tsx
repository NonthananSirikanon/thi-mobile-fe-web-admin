...
import MagazinePage from '../screens/magazine/page/magazine_page'
import AddMagazine from '../screens/magazine/page/add_magazine'
  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/addMagazine/:id" element={<AddMagazine />} />
